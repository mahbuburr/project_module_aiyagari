...
%   Detailed explanation goes here
    ...
    if strcmp(method.sim ,'simulation')
        ...
        tic
        for t = ceil((T+1)/2):T
            k.compensated(t-2500,sim.one.e(t,:)==1) = interp1(U.two.lifetime(1,:), grid.one.k, U.one.extrap(t-2500,sim.one.e(t,:)==1), 'linear', 'extrap');
            k.compensated(t-2500,sim.one.e(t,:)==2) = interp1(U.two.lifetime(2,:), grid.one.k, U.one.extrap(t-2500,sim.one.e(t,:)==2), 'linear', 'extrap');

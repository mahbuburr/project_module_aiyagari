...
\begin{frame}{Changes in idiosyncratic risk}
  \centering{\includegraphics[scale=0.5]{log-deviation}}
...
\begin{frame}{Changes in idiosyncratic risk}
  \centering{\includegraphics[scale=0.5]{distribution}}
...
\begin{frame}{Changes in idiosyncratic risk}
  ...
  \centering{\includegraphics[scale=0.5]{meanandmedian}}
...
\begin{frame}{Changes in idiosyncratic risk}
  ...
  \centering{\includegraphics[scale=0.30]{parameters}}
...
\begin{frame}{Changes in idiosyncratic risk}
  ...
  \centering{\includegraphics[scale=0.30]{parameters_sigma}}

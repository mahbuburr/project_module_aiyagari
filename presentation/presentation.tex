...
\begin{frame}{Problem}
  ...
  \item {
  The introduction of aggregate uncertainty makes the distribution of wealth changing over time, which is an infinite dimensional object.
  }

  \item {
  The capital distribution must be taken into account by the agents, therefore it becomes a state variable.  
  }
